...
$stmt = $db->prepare("SELECT topic_id, passed FROM quiz_results WHERE user_id = ? AND module = 'module02' ORDER BY created_at DESC");
...
<div class="module-container">
    ...
    <div class="module-hero">
        ...
        <p>Master social media marketing from zero to hero</p>
    </div>
    ...
    <div class="module-card">
        <div class="module-header">
            ...
            <div class="module-info">
                ...
                <p>Learn social media marketing fundamentals</p>
            </div>
        </div>
            ...
            <?php foreach ($topics as $topic): ?>
                ...
                <div class="topic-item <?php echo $completion_class; ?>">
                    ...
                    <div class="topic-actions">
                        ...
                        <a href="lecture.php?module=module02&topic=<?php echo $topic['topic_number']; ?>" class="btn-topic btn-view">
                            <i class="fas fa-play"></i> View
                        </a>
                        <!-- Quiz Button: Always show -->
                        <a href="quiz.php?module=module02&topic=<?php echo $topic['topic_number']; ?>" class="btn-topic btn-quiz">
