...
try {
    ...
    if (!$module_info) {
        ...
        $module_info = [
            'id' => 1,
            'module_name' => 'Introduction to FR Collections',
            'color' => '#f59e0b',
...
$stmt = $db->prepare("SELECT topic_id, passed FROM quiz_results WHERE user_id = ? AND module = 'module01' ORDER BY created_at DESC");
...
<div class="module-container">
    ...
    <div class="module-hero">
        ...
        <p>Here you can see a complete breakdown of your training journey</p>
    </div>
    ...
    <div class="module-card">
        <div class="module-header">
            ...
            <div class="module-info">
                ...
                <p>Complete all topics to unlock your Partner ID</p>
            </div>
        </div>
            ...
            <?php foreach ($topics as $topic): ?>
                ...
                <div class="topic-item <?php echo $completion_class; ?>">
                    ...
                    <div class="topic-actions">
                        ...
                        <a href="lecture.php?module=module01&topic=<?php echo $topic['topic_number']; ?>" class="btn-topic btn-view">
                            <i class="fas fa-play"></i> View
                        </a>
                        <!-- Quiz Button: Always show -->
                        <a href="quiz.php?module=module01&topic=<?php echo $topic['topic_number']; ?>" class="btn-topic btn-quiz">
